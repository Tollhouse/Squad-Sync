    ...
    <>
      <div>
        ...
        options={{
          ...
          gantt: {
            trackHeight: 40, // Row height
            barHeight: 30,   // Bar height
            palette: [
              {
                color: '#1e88e5', // Main bar color
                dark: '#1565c0',  // Darker shade for hover or selection
                light: '#bbdefb', // Lighter shade for background
              },
              {
                color: '#43a047',
                dark: '#2e7d32',
