...
exports.seed = async function(knex) {
  ...
  await knex('course_registration').insert([
    ...
    { course_id: 6, user_id: 4, in_progress: 'scheduled', cert_earned: false },
    { course_id: 6, user_id: 9, in_progress: 'scheduled', cert_earned: false },
    { course_id: 6, user_id: 14, in_progress: 'scheduled', cert_earned: false },

    { course_id: 3, user_id: 5, in_progress: 'completed', cert_earned: true },
    { course_id: 3, user_id: 10, in_progress: 'completed', cert_earned: true },
    { course_id: 3, user_id: 15, in_progress: 'completed', cert_earned: true },

    { course_id: 8, user_id: 20, in_progress: 'scheduled', cert_earned: false },
    { course_id: 8, user_id: 25, in_progress: 'scheduled', cert_earned: false },
    { course_id: 8, user_id: 30, in_progress: 'scheduled', cert_earned: false },

    { course_id: 11, user_id: 19, in_progress: 'scheduled', cert_earned: false },
    { course_id: 11, user_id: 24, in_progress: 'scheduled', cert_earned: false },
    { course_id: 11, user_id: 29, in_progress: 'scheduled', cert_earned: false },
  ]);
};
